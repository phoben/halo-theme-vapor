  ...
  class Z extends $ {
    ...
    onRefresh() {
      ...
      n &&
        ...
        (n.removeAttribute(q),
        s.removeAttribute(q),
        t.isInfinite || (i <= 0 && n.setAttribute(q, ""), i >= e - 1 && s.setAttribute(q, "")));
    }
    addBtn(t) {
      var e;
  ...
  class tt extends m {
    ...
    createPages() {
      ...
      for (const e of this.slides)
        (!t.length || o + e.dim - i > 0.05 || a >= n) && (t.push(_()), (s = t.length - 1), (o = 0), (a = 0)),
          t[s].slides.push(e),
          (o += e.dim + e.gap),
          a++;
      return t;
  ...
  let Wt = class extends $ {
    ...
    onClick(t) {
      ...
      let [d, u] = o(c - l, h),
        [p, f] = o(c + l, h);
      u && f
        ? ((a = Math.abs(c - u.getBoundingClientRect().right) < Math.abs(c - f.getBoundingClientRect().left) ? d : p),
          a === n && (a = a === d ? p : d))
        : u
        ? (a = d)
        : f && (a = p),
  ...
  class Ae extends m {
    ...
    focus(t) {
      ...
      t
        ? (!n || c.indexOf(n) < 0) &&
          ((d = h || s),
          c.length && (i === Ee ? (d = c[0]) : (this.lastFocus !== s && i !== xe) || (d = c[c.length - 1])))
