  ...
  var Te = (a, e) => {
    ...
    we = (a, e, t, n) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let r of Re(e))
          !Oe.call(a, r) && r !== t && H(a, r, { get: () => e[r], enumerable: !(n = be(e, r)) || n.enumerable });
      return a;
    };
...
${c}`
          ...
          if (
            ((this.lexer.state.top = !0), this.lexer.blockTokens(c, s, !0), (this.lexer.state.top = f), n.length === 0)
          )
            break;
          let k = s.at(-1);
...
`),
          ...
          this.options.gfm &&
            ...
            i.items.push({ type: "list_item", raw: p, task: !!T, checked: ee, loose: !1, text: c, tokens: [] }),
            (i.raw += p);
        }
        let l = i.items.at(-1);
...
`)
      ...
      if (n.length === r.length) {
        ...
        for (let o = 0; o < n.length; o++)
          s.header.push({ text: n[o], tokens: this.lexer.inline(n[o]), header: !0, align: s.align[o] });
        for (let o of i)
          s.rows.push(
  ...
  var x = class a {
    ...
    constructor(e) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((t.block = B.gfm), this.options.breaks ? (t.inline = M.breaks) : (t.inline = M.gfm)),
      ...
      for (this.options.pedantic && (e = e.replace(m.tabCharGlobal, "    ").replace(m.spaceLine, "")); e; ) {
        ...
        if (
          this.options.extensions?.block?.some((s) =>
            (r = s.call({ lexer: this }, e, t)) ? ((e = e.substring(r.raw.length)), t.push(r), !0) : !1
          )
        )
          continue;
      ...
      for (; e; ) {
        ...
        if (
          this.options.extensions?.inline?.some((u) =>
            (o = u.call({ lexer: this }, e, t)) ? ((e = e.substring(o.raw.length)), t.push(o), !0) : !1
          )
        )
          continue;
